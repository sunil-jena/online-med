...
export default function Dashboard() {
    ...
    return (
        <Layout>
            ...
            "
                ...
                <section className="relative max-w-full py-8 px-6 md:px-8">
                    <div
                        aria-hidden
                        className="
    pointer-events-none absolute inset-x-0 top-0 h-16 z-0
    backdrop-saturate-100 backdrop-blur-[2px]
    bg-transparent
  ...
  "
      ...
      backdrop-saturate-150 backdrop-blur-lg bg-white/8
      [mask-image:linear-gradient(to_bottom,transparent_0%,black_18%,black_70%,transparent_100%)]
    "
                    />
                    <div
                        aria-hidden
                        className="
      pointer-events-none absolute inset-0 z-0
      backdrop-saturate-150 backdrop-blur-lg bg-white/10
      [mask-image:linear-gradient(to_bottom,transparent_0%,transparent_55%,black_92%,black)]
    "
                    />
                                    ...
                                    <div key={c.id} className="relative">
                                        ...
                                        >
                                            ...
                                            <div className="flex items-start gap-3 mb-3">
                                                <div className="relative">{c.patient.avatar}</div>
